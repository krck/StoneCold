...
struct TestComponentArr {
	int a, b;
	TestComponentArr() : a(0), b(0) {}
	TestComponentArr(int ap, int bp) : a(ap), b(bp) {}
};
...
TEST(EntityComponentArray, ConstructDefaultAndMaxSize) {
	auto arr = EntityComponentArray<TestComponentArr>(5);
...
TEST(EntityComponentArray, AccessRandom) {
	auto arr = EntityComponentArray<TestComponentArr>(2);
	arr.insert(10, TestComponentArr(100, 100));
	arr.insert(20, TestComponentArr(200, 200));

	auto aVal1 = arr[10];
	const auto aVal2 = arr[20];
	auto aVal3 = arr[30];

	EXPECT_EQ(aVal1.a, 100);
	EXPECT_EQ(aVal2.a, 200);
	EXPECT_NE(aVal3.a, 0);
}
...
TEST(EntityComponentArray, AccessAt) {
	...
	auto aVal2 = arr.at(20);

	EXPECT_EQ(aVal1.a, 100);
	EXPECT_EQ(aVal2.a, 200);
	ASSERT_ANY_THROW(arr.at(30)) << ".at() failed throw on out of bounds access";
}
...
TEST(EntityComponentArray, InsertSizeEmpty) {
	auto arr = EntityComponentArray<TestComponentArr>(3);
	...
	auto i1 = arr.insert(10, TestComponentArr(100, 100));
	auto i2 = arr.insert(20, TestComponentArr(200, 200));
	auto i3 = arr.insert(30, TestComponentArr(300, 300));
	auto i4 = arr.insert(40, TestComponentArr(400, 400));
...
TEST(EntityComponentArray, InsertCopyMove) {
	...
	auto iVal = TestComponentArr(100, 100);
	arr.insert(10, iVal);
	arr.insert(20, TestComponentArr(200, 200));

	ASSERT_EQ(arr[10].a, iVal.a) << "Failed to copy insert() a value";
	ASSERT_EQ(arr[20].b, TestComponentArr(200, 200).b) << "Failed to move insert() a value";
}
...
TEST(EntityComponentArray, InsertIndexCheck) {
	...
	arr.insert(10, TestComponentArr(100, 100));
	arr.insert(20, TestComponentArr(200, 200));
	arr.insert(30, TestComponentArr(300, 300));
	arr.insert(40, TestComponentArr(400, 400));

	// Check if the used memory is continuous
	//EXPECT_EQ((int)&arr.GetRawData()[1], (int)&arr.GetRawData()[0] + sizeof(TestComponentArr));
	//EXPECT_EQ((int)&arr.GetRawData()[2], (int)&arr.GetRawData()[1] + sizeof(TestComponentArr));
...
TEST(EntityComponentArray, InsertReplace) {
	...
	arr.insert(10, TestComponentArr(200, 200));
...
TEST(EntityComponentArray, Erase) {
	...
	arr.insert(30, TestComponentArr(300, 300));
	arr.insert(40, TestComponentArr(400, 400));
	arr.insert(50, TestComponentArr(500, 500));
