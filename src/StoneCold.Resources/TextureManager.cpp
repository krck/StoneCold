...
bool StoneCold::Resources::TextureManager::LoadResources(const std::vector<Resource>& resources) {
...
bool StoneCold::Resources::TextureManager::UnloadResources(const std::vector<uint>& resourceIds) {
	return false;
}
...
//
void TextureManager::LoadTexture(const Resource& resource) {
	try {
